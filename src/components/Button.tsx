...
const VARIANT = {
  blue: "flex items-center justify-center text-base gap-1 bg-blue-800 text-white rounded-md text-center py-3 hover:opacity-80 active:bg-blue-900  active:opacity-100 ease-linear duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-gray-500 disabled:bg-gray-500 px-7",
  white:
